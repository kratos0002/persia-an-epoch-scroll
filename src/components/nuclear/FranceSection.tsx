...
const steps = [
  ...
  <div key="frappe-science">
    <p className="font-body text-base leading-relaxed mb-4" style={{ color: STEEL }}>
      France had actually started nuclear research during the war and had extraordinary scientific foundations. <span style={{ color: LIGHT }}>Frédéric Joliot-Curie</span> — son-in-law of <span style={{ color: LIGHT }}>Marie Curie</span> and a Nobel laureate in his own right — had led early French nuclear work and helped establish the <span style={{ color: LIGHT }}>Commissariat à l'énergie atomique</span> in 1945.
    </p>
    <p className="font-body text-base leading-relaxed" style={{ color: STEEL }}>
  ...
  <div key="frappe-test">
    <p className="font-body text-base leading-relaxed mb-4" style={{ color: STEEL }}>
      On February 13, 1960, France detonated "<span style={{ color: LIGHT }}>Gerboise Bleue</span>" — a <span style={{ color: LIGHT }}>70-kiloton</span> plutonium device — in the Sahara Desert at Reggane, Algeria. It was more than <span style={{ color: LIGHT }}>three times the yield of Trinity</span>. France had made its point: it would defend itself, by itself.
    </p>
  ...
  <div key="frappe-nato">
    <p className="font-body text-base leading-relaxed mb-4" style={{ color: STEEL }}>
      De Gaulle then <span style={{ color: LIGHT }}>withdrew France from NATO's integrated military command</span> — not from the alliance itself, but from the structure that would have placed French forces under American control. France would be an ally, not a subordinate.
    </p>
    <p className="font-body text-base leading-relaxed" style={{ color: STEEL }}>
    ...
    <NewspaperClip
      paper="Le Monde"
      date="14 Février 1960"
      headline="LA FRANCE A FAIT EXPLOSER SA PREMIÈRE BOMBE ATOMIQUE"
      subheadline="L'engin a été mis à feu ce matin à Reggane, dans le Sahara"
      delay={0.5}
    />
  </div>,
];
