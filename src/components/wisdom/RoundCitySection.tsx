...
import roundCityMap from '@/assets/round-city-farrukh.png';
  ...
  return (
    <div className="w-full h-full flex items-center justify-center">
      <div className="relative w-80 h-80 md:w-[28rem] md:h-[28rem]">
        {/* Historical map — fades in at step 2, fully visible at step 3 */}
        <motion.div
          className="absolute inset-0 flex items-center justify-center"
          initial={{ opacity: 0 }}
          animate={{ opacity: activeStep >= 3 ? 0.6 : activeStep >= 2 ? 0.3 : 0 }}
        ...
        >
          ...
          >
            <img
              src={roundCityMap}
              alt="Historical map of the Round City of Baghdad by Umar Farrukh"
              className="w-full h-full object-cover sepia"
              style={{
                filter: 'sepia(0.4) hue-rotate(120deg) brightness(1.0) contrast(1.1)',
              }}
            />
          </div>
        </motion.div>
