...
export const STAGES: BattutaStage[] = [
  ...
  { id: 'phase3-constantinople', center: [41.008, 28.978], zoom: 7, pitch: 55, bearing: 230, speed: 1.2, label: 'Constantinople', phase: 'Anatolia & the Golden Horde', phaseIndex: 2, date: '1334', routeUpTo: 19, markers: [{ coords: [28.978, 41.008], label: 'Constantinople', detail: 'Hagia Sophia' }], narrative: { title: 'Constantinople — Beyond the Dar al-Islam', body: 'Accompanying Princess Bayalun on a visit to her father, Ibn Battuta entered Constantinople — the greatest Christian city in the world. His reaction to the Hagia Sophia was awe at its scale, though he noted with scholarly discomfort the "pagan" icons within.', accent: '~6,000 km in Phase 3 alone — from Konya to the frozen steppes of Russia and back.', image: { src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/22/Hagia_Sophia_Mars_2013.jpg/800px-Hagia_Sophia_Mars_2013.jpg', alt: 'Hagia Sophia exterior view', caption: 'Hagia Sophia — the great basilica that left Ibn Battuta in awe' } } },
  ...
  { id: 'phase4-delhi', center: [28.613, 77.209], zoom: 6, pitch: 55, bearing: 130, speed: 1.5, label: 'Delhi', phase: 'The Delhi Sultanate', phaseIndex: 3, date: '1334–1341', routeUpTo: 23, markers: [{ coords: [77.209, 28.613], label: 'Delhi', detail: '7 years as Qadi' }], narrative: { title: 'Delhi — Seven Years of Luxury and Terror', body: 'Muhammad bin Tughluq appointed Ibn Battuta as the Qadi of Delhi — the highest judicial post in the sultanate. He received a massive salary and lived in luxury, but the Sultan was a man of "radical extremes": a brilliant philosopher who executed citizens daily for minor infractions.', quote: { text: 'The sultan is far too free in shedding blood... every day there are people who are brought in chains, and are killed, and their wealth confiscated.', attribution: 'Ibn Battuta on Muhammad bin Tughluq' }, image: { src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Qutb_Minar_in_the_monsoons.jpg/800px-Qutb_Minar_in_the_monsoons.jpg', alt: 'Qutub Minar tower in Delhi', caption: 'Qutub Minar, Delhi — the great minaret already stood when Ibn Battuta served as Qadi' } } },
  { id: 'phase4-calicut', center: [11.258, 75.780], zoom: 6, pitch: 55, bearing: 190, speed: 1.2, label: 'Calicut', phase: 'The Delhi Sultanate', phaseIndex: 3, date: '1341', routeUpTo: 25, markers: [{ coords: [75.780, 11.258], label: 'Calicut', detail: 'Embassy shipwreck' }], narrative: { title: 'Calicut — The Failed Embassy', body: 'Sent as the Sultan\'s ambassador to Yuan Dynasty China, Ibn Battuta\'s mission collapsed in disaster. A storm destroyed the embassy\'s ships in the harbor of Calicut, drowning gifts worth a fortune. Fearing the Sultan\'s wrath, he fled south.', accent: '~4,500 km in Phase 4. The most dramatic and detailed section of the entire Rihla.' } },

  // Phase 5: Maldives to China — heading far east
  { id: 'phase5-male', center: [4.175, 73.509], zoom: 7, pitch: 55, bearing: 200, speed: 1, label: 'Malé', phase: 'Maldives to China', phaseIndex: 4, date: '1342', routeUpTo: 26, markers: [{ coords: [73.509, 4.175], label: 'Malé', detail: 'Qadi for 2 years' }], narrative: { title: 'Malé — Island Qadi', body: 'Fleeing south from the failed embassy, Ibn Battuta reached the Maldive Islands, where he was again appointed qadi. He married into the royal family, enforced Islamic law with zealous rigor, and became embroiled in political intrigues.' } },
  { id: 'phase5-srilanka', center: [7.293, 80.636], zoom: 7, pitch: 55, bearing: 60, speed: 1, label: 'Sri Lanka', phase: 'Maldives to China', phaseIndex: 4, date: '1344', routeUpTo: 27, markers: [{ coords: [80.636, 7.293], label: 'Sri Lanka', detail: 'Adam\'s Peak' }], narrative: { title: 'Sri Lanka — Adam\'s Peak', body: 'Ibn Battuta visited the sacred footprint atop Adam\'s Peak — revered by Muslims as the footprint of Adam, by Buddhists as Buddha\'s, and by Hindus as Shiva\'s. This was the syncretic religious landscape of the Indian Ocean world.' } },
  { id: 'phase5-quanzhou', center: [24.874, 118.675], zoom: 6, pitch: 60, bearing: 55, speed: 1.8, label: 'Quanzhou', phase: 'Maldives to China', phaseIndex: 4, date: '1345', routeUpTo: 29, markers: [{ coords: [118.675, 24.874], label: 'Quanzhou', detail: 'Zaytun — Chinese port' }], narrative: { title: 'Quanzhou — The Eastern Extreme', body: 'Landing at Quanzhou (Zaytun), Ibn Battuta reached the eastern extreme of the Islamic world. He was impressed by China\'s safety and craftsmanship — its porcelain, silk, and paper currency — but deeply troubled by the dominance of "paganism."' } },
  { id: 'phase5-beijing', center: [39.904, 116.391], zoom: 5, pitch: 60, bearing: 350, speed: 1.5, label: 'Beijing', phase: 'Maldives to China', phaseIndex: 4, date: '1346', routeUpTo: 31, markers: [{ coords: [116.391, 39.904], label: 'Beijing', detail: 'Khan Baliq — debated visit' }], narrative: { title: 'Beijing — The Disputed Claim', body: 'Whether Ibn Battuta actually reached Beijing is one of the great scholarly debates. His descriptions of North China are far less detailed than his vivid accounts of India or Anatolia, suggesting he may have relied on reports from fellow merchants.', accent: '~12,000 km in Phase 5 — the longest single phase, spanning from the Maldives to the theoretical northern extreme of Yuan China.' } },
  ...
  { id: 'phase7-timbuktu', center: [16.766, -3.002], zoom: 6, pitch: 55, bearing: 200, speed: 1, label: 'Timbuktu', phase: 'Al-Andalus & Mali', phaseIndex: 6, date: '1353', routeUpTo: 43, markers: [{ coords: [-3.002, 16.766], label: 'Timbuktu', detail: 'Center of learning' }], narrative: { title: 'Timbuktu — City of Scholars', body: 'Reaching Timbuktu, Ibn Battuta found a city of madrasas and mosques on the edge of the Niger River — a center of Islamic scholarship that linked the Saharan trade routes to the agricultural wealth of the Niger basin.', image: { src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/Djinguereber.jpg/800px-Djinguereber.jpg', alt: 'Djinguereber Mosque in Timbuktu', caption: 'Djinguereber Mosque, Timbuktu — built in 1327, standing when Ibn Battuta arrived' } } },
