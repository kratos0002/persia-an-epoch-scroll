...
export const STAGES: BattutaStage[] = [
  ...
  { id: 'phase3-constantinople', center: [41.008, 28.978], zoom: 7, pitch: 55, bearing: 230, speed: 1.2, label: 'Constantinople', phase: 'Anatolia & the Golden Horde', phaseIndex: 2, date: '1334', routeUpTo: 19, markers: [{ coords: [28.978, 41.008], label: 'Constantinople', detail: 'Hagia Sophia' }], narrative: { title: 'Constantinople — Beyond the Dar al-Islam', body: 'Accompanying Princess Bayalun on a visit to her father, Ibn Battuta entered Constantinople — the greatest Christian city in the world. His reaction to the Hagia Sophia was awe at its scale, though he noted with scholarly discomfort the "pagan" icons within.', accent: '~6,000 km in Phase 3 alone — from Konya to the frozen steppes of Russia and back.' } },
  ...
  { id: 'phase7-timbuktu', center: [16.766, -3.002], zoom: 6, pitch: 55, bearing: 200, speed: 1, label: 'Timbuktu', phase: 'Al-Andalus & Mali', phaseIndex: 6, date: '1353', routeUpTo: 43, markers: [{ coords: [-3.002, 16.766], label: 'Timbuktu', detail: 'Center of learning' }], narrative: { title: 'Timbuktu — City of Scholars', body: 'Reaching Timbuktu, Ibn Battuta found a city of madrasas and mosques on the edge of the Niger River — a center of Islamic scholarship that linked the Saharan trade routes to the agricultural wealth of the Niger basin.' } },
